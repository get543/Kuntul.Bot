module.exports = async (Discord, client, message) => {
  ...
  if (message.content.toLowerCase() == "dm sabi") {
    ...
    message.channel.send(
      `https://cdn.discordapp.com/attachments/802199069342433340/874463489438122064/20210810_082456.jpg`
    );
    ...
    message.channel.send(
      `https://cdn.discordapp.com/attachments/802199069342433340/878183655284015114/IMG_20210820_144653.jpg`
    );
    ...
    message.channel.send(
      `https://cdn.discordapp.com/attachments/802199069342433340/827030744282824764/image0.jpg`
    );
  }
};
