    ...
    if (args.join(" ") == "sendfile") {
      ...
      const newEmbed = new Discord.MessageEmbed()
        ...
        .addFields(
          ...
          {
            name: `${prefix}help sendfile`,
            value: "list command kirim sebagai file .txt",
          },
          {
            name: `${prefix}details`,
            value: "liat lebih detail lagi tentang setiap command nya",
          },
          { name: `${prefix}isepkontolgw`, value: "anime isep kontol" },
          {
            name: `${prefix}tititbesar`,
            value: "uwaw titit besar sekali nich",
          },
          {
            name: `${prefix}idulfitri`,
            value: "selamat idul fitri dari semua pihak",
          },
          {
            name: `${prefix}colbar`,
            value: "khusus untuk para kaum duo colbar",
          },
          ...
          {
            name: `${prefix}fallguys`,
            value: "fall guys more like sussy guys",
          },
